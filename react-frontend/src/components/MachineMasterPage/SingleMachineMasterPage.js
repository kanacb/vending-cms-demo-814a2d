    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">Ownership</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.ownership}</p></div>
                    <label className="text-sm text-primary">Vmcode</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.vmcode}</p></div>
                    <label className="text-sm text-primary">Zone</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.zone}</p></div>
                    <label className="text-sm text-primary">Location Code</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.locationCode}</p></div>
                    <label className="text-sm text-primary">Location Desc</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.locationDesc}</p></div>
                    <label className="text-sm text-primary">Model No</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.modelNo}</p></div>
                    <label className="text-sm text-primary">Serial Number</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.serialNumber}</p></div>
                    <label className="text-sm text-primary">Vm Id</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.vmId}</p></div>
                    <label className="text-sm text-primary">purchaseDate</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.purchaseDate}</p></div>
                    <label className="text-sm text-primary">commissionDate</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.commissionDate}</p></div>
