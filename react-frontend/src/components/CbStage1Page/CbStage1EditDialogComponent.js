    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div>
                ...
                <Dropdown value={_entity?.SecDoorPanel} options={SecDoorPanelOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("SecDoorPanel", {_id : e.value})} />
            </div>
            <div>
                <p className="m-0">SecDoorFlap:</p>
                <Dropdown value={_entity?.SecDoorFlap} options={SecDoorFlapOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("SecDoorFlap", {_id : e.value})} />
            </div>
            <div>
                <p className="m-0">ColumnStnd:</p>
                <Dropdown value={_entity?.ColumnStnd} options={ColumnStndOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ColumnStnd", {_id : e.value})} />
            </div>
            <div>
                <p className="m-0">ColumnMod:</p>
                <Dropdown value={_entity?.ColumnMod} options={ColumnModOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ColumnMod", {_id : e.value})} />
            </div>
            <div>
                <p className="m-0">ColumnFlipper:</p>
                <Dropdown value={_entity?.ColumnFlipper} options={ColumnFlipperOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ColumnFlipper", {_id : e.value})} />
            </div>
            <div>
                <p className="m-0">ProductChute:</p>
                <Dropdown value={_entity?.ProductChute} options={ProductChuteOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ProductChute", {_id : e.value})} />
            </div>
            <div>
                <p className="m-0">MachineMaintenance:</p>
                <Dropdown value={_entity?.MachineMaintenance} options={MachineMaintenanceOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("MachineMaintenance", {_id : e.value})} />
            </div>
            <div>
            ...
            <div>
                ...
                <Dropdown value={_entity?.Wiring} options={WiringOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("Wiring", {_id : e.value})} />
            </div>
            <div>
                <p className="m-0">Motor:</p>
                <Dropdown value={_entity?.Motor} options={MotorOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("Motor", {_id : e.value})} />
            </div>
