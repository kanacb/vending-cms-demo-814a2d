...
const SecDoorPanelOptions = SecDoorPanelArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
const SecDoorFlapArray = ["AV","GOOD","XAV","XGOOD"]
const SecDoorFlapOptions = SecDoorFlapArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
const ColumnStndArray = ["AV","GOOD","XAV","XGOOD"]
const ColumnStndOptions = ColumnStndArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
const ColumnModArray = ["AV","GOOD","XAV","XGOOD"]
const ColumnModOptions = ColumnModArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
const ColumnFlipperArray = ["AV","GOOD","XAV","XGOOD"]
const ColumnFlipperOptions = ColumnFlipperArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
const ProductChuteArray = ["AV","GOOD","XAV","XGOOD"]
const ProductChuteOptions = ProductChuteArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
const MachineMaintenanceArray = ["AV","GOOD","XAV","XGOOD"]
const MachineMaintenanceOptions = MachineMaintenanceArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
...
const WiringOptions = WiringArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
const MotorArray = ["AV","GOOD","XAV","XGOOD"]
const MotorOptions = MotorArray.map((x) => ({ name: x, value: x })).sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric : true, sensitivity: "base"}));
...
const CbStage1CreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit Can Bottle Stage 1" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="SecDoorPanel" value={_entity?.SecDoorPanel} options={SecDoorPanelOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("SecDoorPanel", e.value)} />
                    <label htmlFor="SecDoorPanel">SecDoorPanel:</label>
                </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="SecDoorFlap" value={_entity?.SecDoorFlap} options={SecDoorFlapOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("SecDoorFlap", e.value)} />
                    <label htmlFor="SecDoorFlap">SecDoorFlap:</label>
                </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="ColumnStnd" value={_entity?.ColumnStnd} options={ColumnStndOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ColumnStnd", e.value)} />
                    <label htmlFor="ColumnStnd">ColumnStnd:</label>
                </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="ColumnMod" value={_entity?.ColumnMod} options={ColumnModOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ColumnMod", e.value)} />
                    <label htmlFor="ColumnMod">ColumnMod:</label>
                </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="ColumnFlipper" value={_entity?.ColumnFlipper} options={ColumnFlipperOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ColumnFlipper", e.value)} />
                    <label htmlFor="ColumnFlipper">ColumnFlipper:</label>
                </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="ProductChute" value={_entity?.ProductChute} options={ProductChuteOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("ProductChute", e.value)} />
                    <label htmlFor="ProductChute">ProductChute:</label>
                </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="MachineMaintenance" value={_entity?.MachineMaintenance} options={MachineMaintenanceOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("MachineMaintenance", e.value)} />
            ...
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="Wiring" value={_entity?.Wiring} options={WiringOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("Wiring", e.value)} />
                    <label htmlFor="Wiring">Wiring:</label>
                </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Dropdown id="Motor" value={_entity?.Motor} options={MotorOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("Motor", e.value)} />
