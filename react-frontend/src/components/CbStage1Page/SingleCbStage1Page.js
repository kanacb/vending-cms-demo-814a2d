...
const SingleCbStage1Page = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("cbStage1")
            .get(urlParams.singleCbStage1Id, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Ref</label><p className="" >{_entity?.Ref?.RefNo}</p></div>
                    ...
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">ProductChute</label><p className="" >{_entity?.ProductChute}</p></div>
