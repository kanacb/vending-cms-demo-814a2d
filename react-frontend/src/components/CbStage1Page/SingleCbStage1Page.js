      ...
      <div className="card w-full">
        <div className="grid ">
          <div className="col-12 md:col-6 lg:col-3">
            ...
            <p className="">{_entity?.ExternalBody}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
            <label className="text-sm text-primary">InternalBody</label>
            <p className="">{_entity?.InternalBody}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
          ...
          <div className="col-12 md:col-6 lg:col-3">
            ...
            <p className="">{_entity?.Wiring}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
            <label className="text-sm text-primary">Motor</label>
            <p className="">{_entity?.Motor}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
