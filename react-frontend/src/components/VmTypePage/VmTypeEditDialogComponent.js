...
const VmTypeCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        const result = await client.service("vmType").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info vmType updated successfully" });
    ...
    return (
        <Dialog header="Edit Vm Type" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="vmType-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(VmTypeCreateDialogComponent);
