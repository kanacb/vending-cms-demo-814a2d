          ...
          <div className="flex h-full">
            ...
            >
              ...
              <div className="border-round flex-auto">
                <div
                  className={classNames("p-3 font-medium text-2xl text-white", {
                    hidden: activeTab2 !== 0,
                  })}
                >
                  Dashboard
