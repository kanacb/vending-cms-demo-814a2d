...
const CBMasterFormLayout = (props) => {
      ...
      items: [
        {
          ...
          to: `/cBMasterForm/${urlParams.singleCBMasterFormId}/single`,
        },
        {
          label: "Can Bottle Stage 1",
          icon: "pi pi-fw pi-cog",
          to: `/cBMasterForm/${urlParams.singleCBMasterFormId}/cbStage1`,
        },
        {
          label: "Can Bottle Stage 2",
          icon: "pi pi-fw pi-cog",
          to: `/cBMasterForm/${urlParams.singleCBMasterFormId}/cbStage2`,
        },
        {
          label: "CB Stage 1 Agree",
          icon: "pi pi-fw pi-cog",
          to: `/cBMasterForm/${urlParams.singleCBMasterFormId}/cbStage1Agree`,
        },
        {
          label: "CB Stage 2 Agree",
          icon: "pi pi-fw pi-cog",
          to: `/cBMasterForm/${urlParams.singleCBMasterFormId}/cbStage2Agree`,
        },
      ],
    },
  ];
...
const mapState = (state) => {
  ...
  return { selectedCBMasterForm, menuOpen };
};
const mapDispatch = (dispatch) => ({
  setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
  getOneCBMasterForm: (id) => dispatch.cBMasterForm.getOneCBMasterForm(id),
});

export default connect(mapState, mapDispatch)(CBMasterFormLayout);
