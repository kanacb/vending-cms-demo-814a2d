...
const CbStage2DataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate23 = (rowData, { rowIndex }) => <p >{rowData.remarks}</p>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            ...
            <Column field="MachineMaintenance" header="MachineMaintenance" body={pTemplate13} style={{ minWidth: "8rem" }} />
            <Column field="PSUBoard" header="PSUBoard" body={pTemplate14} style={{ minWidth: "8rem" }} />
            <Column field="VendBoard" header="VendBoard" body={pTemplate15} style={{ minWidth: "8rem" }} />
            <Column field="RelaySupply" header="RelaySupply" body={pTemplate16} style={{ minWidth: "8rem" }} />
            <Column field="MemoryBoard" header="MemoryBoard" body={pTemplate17} style={{ minWidth: "8rem" }} />
            <Column field="Remote" header="Remote" body={pTemplate18} style={{ minWidth: "8rem" }} />
            <Column field="Compressor" header="Compressor" body={pTemplate19} style={{ minWidth: "8rem" }} />
            <Column field="CoolingFan" header="CoolingFan" body={pTemplate20} style={{ minWidth: "8rem" }} />
            <Column field="Wiring" header="Wiring" body={pTemplate21} style={{ minWidth: "8rem" }} />
            <Column field="Motor" header="Motor" body={pTemplate22} style={{ minWidth: "8rem" }} />
            <Column field="remarks" header="Remarks" body={pTemplate23} style={{ minWidth: "8rem" }} />
