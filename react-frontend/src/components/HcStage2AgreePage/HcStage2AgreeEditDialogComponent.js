...
const HcStage2AgreeCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit HC Stage 2 Agree" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Checkbox id="TechTrade" checked={_entity?.TechTrade} onChange={ (e) => setValByKey("TechTrade", e.checked)}  ></Checkbox>
            ...
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Checkbox id="SvTrade" checked={_entity?.SvTrade} onChange={ (e) => setValByKey("SvTrade", e.checked)}  ></Checkbox>
