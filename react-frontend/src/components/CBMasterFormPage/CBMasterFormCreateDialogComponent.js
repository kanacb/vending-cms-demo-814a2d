...
const CBMasterFormCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create Can Bottle Master Form" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
