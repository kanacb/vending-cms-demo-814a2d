    ...
    <div className="col-12 flex flex-column align-items-center">
      ...
      <div className="card w-full">
        <div className="grid ">
          ...
          <div className="col-12 md:col-12 lg:col-6">
            <label className="text-sm text-primary">Technician Remarks</label>
            <p className="m-0 ml-3">{_entity?.technicianRemark}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
            <label className="text-sm text-primary">Visited Date</label>
            <p className="m-0 ml-3">{moment(_entity?.visitDate).fromNow()}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
            <label className="text-sm text-primary">Reported Date</label>
            <p className="m-0 ml-3">{moment(_entity?.reportDate).fromNow()}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
            <label className="text-sm">Ops Centre</label>
            <p>
              {opsCentreId.map((elem) => (
