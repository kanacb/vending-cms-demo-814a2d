    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">Ops Centre Id</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.opsCentreId}</p></div>
                    <label className="text-sm text-primary">locationId</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.locationId?.name}</p></div>
                    <label className="text-sm text-primary">visitDate</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.visitDate}</p></div>
                    <label className="text-sm text-primary">reportDate</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.reportDate}</p></div>
                    <label className="text-sm text-primary">Reason For Breakdown</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.reasonForBreakdown}</p></div>
                    <label className="text-sm text-primary">Technician Remark</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.technicianRemark}</p></div>
                    <label className="text-sm text-primary">machineId</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.machineId?.vmcode}</p></div>
                    <label className="text-sm text-primary">technicianId</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.technicianId?.name}</p></div>
