      ...
      <div role="breakdown-edit-dialog-component">
        <div>
          ...
          <InputText
            ...
            onChange={(e) => setValByKey("opsCentreId", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <Calendar
            ...
            onChange={(e) => setValByKey("visitDate", new Date(e.target.value))}
            showIcon
            showButtonBar
          ></Calendar>
        </div>
        ...
        <div>
          ...
          <InputText
            ...
            onChange={(e) => setValByKey("reasonForBreakdown", e.target.value)}
          />
        </div>
        <div>
