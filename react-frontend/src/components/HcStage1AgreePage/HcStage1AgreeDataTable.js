...
const HcStage1AgreeDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const calendarTemplate11 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.ManagerDate)} ></Calendar>
