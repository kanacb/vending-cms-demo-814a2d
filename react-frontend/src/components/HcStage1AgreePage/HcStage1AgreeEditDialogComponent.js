...
const HcStage1AgreeCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit HC Stage 1 Agree" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
