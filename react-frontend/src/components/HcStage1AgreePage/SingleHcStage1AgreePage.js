    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Ref</label><p className="" >{_entity?.Ref?.RefNo}</p></div>
                    ...
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">ManagerSign</label><p className="" >{_entity?.ManagerSign}</p></div>
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">ManagerDate</label>{moment(_entity?.ManagerDate).fromNow()}</div>
