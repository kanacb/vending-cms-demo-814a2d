...
const HCMasterFormDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const calendarTemplate5 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.DateInspec)} ></Calendar>
    const calendarTemplate6 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.DateRecall)} ></Calendar>
