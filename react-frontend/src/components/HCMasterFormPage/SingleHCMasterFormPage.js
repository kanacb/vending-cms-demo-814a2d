...
const SingleHCMasterFormPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleHCMasterFormId, {
        query: {
          $populate: [
            {
              path: "createdBy",
