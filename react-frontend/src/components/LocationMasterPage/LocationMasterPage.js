...
const LocationMasterPage = (props) => {
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("locationMaster").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
      ...
      <div className="grid">
        ...
        <div className="col-6 flex justify-content-end">
          <Button
            ...
            role="locationMaster-add-button"
          />
          <SplitButton
