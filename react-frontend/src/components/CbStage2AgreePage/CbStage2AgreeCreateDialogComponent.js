...
const CbStage2AgreeCreateDialogComponent = (props) => {
  ...
  return (
    <Dialog
      header="Create CB Stage 2 Agree"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="cbStage2Agree-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="p-float-label">
            <Calendar
              ...
              onChange={(e) =>
                setValByKey("TechDate", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            ></Calendar>
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="p-float-label">
            <Calendar
              ...
              onChange={(e) =>
                setValByKey("TechTrade", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            ></Calendar>
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="p-float-label">
            <Calendar
              ...
              onChange={(e) => setValByKey("SvDate", new Date(e.target.value))}
              showIcon
              showButtonBar
            ></Calendar>
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="p-float-label">
            <Calendar
              ...
              onChange={(e) => setValByKey("SvTrade", new Date(e.target.value))}
              showIcon
              showButtonBar
            ></Calendar>
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="p-float-label">
            <Calendar
              ...
              onChange={(e) =>
                setValByKey("MngrDate", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            ></Calendar>
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="p-float-label">
            <Calendar
              ...
              onChange={(e) =>
                setValByKey("MngrTrade", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            ></Calendar>
