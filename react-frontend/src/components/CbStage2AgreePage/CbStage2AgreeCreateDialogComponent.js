...
const CbStage2AgreeCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create CB Stage 2 Agree" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Calendar id="TechTrade" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(_entity?.TechTrade)} onChange={ (e) => setValByKey("TechTrade", new Date(e.target.value))} showIcon showButtonBar ></Calendar>
            ...
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Calendar id="SvTrade" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(_entity?.SvTrade)} onChange={ (e) => setValByKey("SvTrade", new Date(e.target.value))} showIcon showButtonBar ></Calendar>
            ...
            <div className="col-12 md:col-6 field mt-5">
                <span className="p-float-label">
                    <Calendar id="MngrTrade" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(_entity?.MngrTrade)} onChange={ (e) => setValByKey("MngrTrade", new Date(e.target.value))} showIcon showButtonBar ></Calendar>
