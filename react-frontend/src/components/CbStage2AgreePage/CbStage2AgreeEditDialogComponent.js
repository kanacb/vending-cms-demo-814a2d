...
const CbStage2AgreeCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit CB Stage 2 Agree" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
