...
const CbStage2AgreeDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const calendarTemplate4 = (rowData, { rowIndex }) => <Calendar dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.TechTrade)} ></Calendar>
    ...
    const calendarTemplate8 = (rowData, { rowIndex }) => <Calendar dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.SvTrade)} ></Calendar>
    ...
    const calendarTemplate12 = (rowData, { rowIndex }) => <Calendar dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.MngrTrade)} ></Calendar>
