...
const CbStage2AgreeDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const calendarTemplate3 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.TechDate)} ></Calendar>
    const calendarTemplate4 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.TechTrade)} ></Calendar>
    const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.SvName}</p>
    const pTemplate6 = (rowData, { rowIndex }) => <p >{rowData.SvSign}</p>
    const calendarTemplate7 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.SvDate)} ></Calendar>
    const calendarTemplate8 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.SvTrade)} ></Calendar>
    const pTemplate9 = (rowData, { rowIndex }) => <p >{rowData.MngrName}</p>
    const pTemplate10 = (rowData, { rowIndex }) => <p >{rowData.MngrSign}</p>
    const calendarTemplate11 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.MngrDate)} ></Calendar>
    const calendarTemplate12 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.MngrTrade)} ></Calendar>
