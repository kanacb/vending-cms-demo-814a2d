...
const SingleCbStage2AgreePage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleCbStage2AgreeId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      <div className="card w-full">
        <div className="grid ">
          ...
          <div className="col-12 md:col-6 lg:col-3">
            ...
            <p className="m-0 ml-3">{moment(_entity?.TechTrade).fromNow()}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
          ...
          <div className="col-12 md:col-6 lg:col-3">
            ...
            <p className="m-0 ml-3">{moment(_entity?.SvTrade).fromNow()}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
          ...
          <div className="col-12 md:col-6 lg:col-3">
            ...
            <p className="m-0 ml-3">{moment(_entity?.MngrTrade).fromNow()}</p>
          </div>
          <div className="col-12 md:col-6 lg:col-3">
